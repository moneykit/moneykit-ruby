...
module MoneyKit
  class TransactionsApi
    ...
    # @param txn_id [String] 
    # @param bud_category [BudCategory] 
    # @param [Hash] opts the optional parameters
    # @return [ApiPublicTransactionsGetTransactionsResponse]
    def correct_enrichment(id, txn_id, bud_category, opts = {})
      data, _status_code, _headers = correct_enrichment_with_http_info(id, txn_id, bud_category, opts)
      data
    end
    ...
    # @param bud_category [BudCategory] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ApiPublicTransactionsGetTransactionsResponse, Integer, Hash)>] ApiPublicTransactionsGetTransactionsResponse data, response status code and response headers
    def correct_enrichment_with_http_info(id, txn_id, bud_category, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TransactionsApi.correct_enrichment ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling TransactionsApi.correct_enrichment"
      end
      # verify the required parameter 'txn_id' is set
      if @api_client.config.client_side_validation && txn_id.nil?
        fail ArgumentError, "Missing the required parameter 'txn_id' when calling TransactionsApi.correct_enrichment"
      end
      # verify the required parameter 'bud_category' is set
      if @api_client.config.client_side_validation && bud_category.nil?
        fail ArgumentError, "Missing the required parameter 'bud_category' when calling TransactionsApi.correct_enrichment"
      end
      # resource path
      local_var_path = '/links/{id}/transactions/{txn_id}/enrichment'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'txn_id' + '}', CGI.escape(txn_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(bud_category)

      # return_type
      return_type = opts[:debug_return_type] || 'ApiPublicTransactionsGetTransactionsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2ClientCredentials']

      new_options = opts.merge(
        :operation => :"TransactionsApi.correct_enrichment",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TransactionsApi#correct_enrichment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [Date] :start_date The earliest date for which data should be returned, formatted as YYYY-MM-DD.
    # @option opts [Date] :end_date The latest date for which data should be returned, formatted as YYYY-MM-DD.
    # @return [Array<(ApiPublicTransactionsLegacyGetTransactionsResponse, Integer, Hash)>] ApiPublicTransactionsLegacyGetTransactionsResponse data, response status code and response headers
    def get_transactions_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'size'].nil? && opts[:'size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"size"]" when calling TransactionsApi.get_transactions, must be smaller than or equal to 1000.'
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ApiPublicTransactionsLegacyGetTransactionsResponse'
    ...
    def get_user_transactions_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'size'].nil? && opts[:'size'] > 1000
        fail ArgumentError, 'invalid value for "opts[:"size"]" when calling TransactionsApi.get_user_transactions, must be smaller than or equal to 1000.'
      end
