...
module MoneyKit
  class InstitutionStylingResponse
    ...
    # URL to the avatar image for this institution
    attr_accessor :avatar

    # URL to the dark-mode avatar image for this institution
    attr_accessor :avatar_dark

    # URL to the logo image for this institution
    attr_accessor :logo

    # URL to the dark-mode logo image for this institution
    ...
    def hash
      [name, domain, color, color_dark, avatar, avatar_dark, logo, logo_dark].hash
    end
