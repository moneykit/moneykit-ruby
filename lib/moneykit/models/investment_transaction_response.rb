...
module MoneyKit
  class InvestmentTransactionResponse
    ...
    # @param [Object] investment_transaction_id Value to be assigned
    def investment_transaction_id=(investment_transaction_id)
      if investment_transaction_id.nil?
        fail ArgumentError, 'investment_transaction_id cannot be nil'
      end
