  ...
  class LinkErrorForbiddenActionResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MoneyKit::LinkErrorForbiddenActionResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MoneyKit::LinkErrorForbiddenActionResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'error_code')
        ...
        self.error_code = 'link_error.forbidden_action'
      end
    ...
    def error_code=(error_code)
      validator = EnumAttributeValidator.new('String', ["link_error.forbidden_action"])
