...
module MoneyKit
  class AccountNumbersLegacy20230218
    # The ACH account and routing numbers.
    attr_accessor :ach

    # The EFT transfer numbers.
    attr_accessor :eft

    # The BACS account number and sort code.
    attr_accessor :bacs

    # Internationally recognized transfer numbers.
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MoneyKit::AccountNumbersLegacy20230218`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] ach Value to be assigned
    def ach=(ach)
      if ach.nil?
        fail ArgumentError, 'ach cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] eft Value to be assigned
    def eft=(eft)
      if eft.nil?
        fail ArgumentError, 'eft cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] bacs Value to be assigned
    def bacs=(bacs)
      if bacs.nil?
        fail ArgumentError, 'bacs cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] international Value to be assigned
    def international=(international)
      if international.nil?
        fail ArgumentError, 'international cannot be nil'
      end
    ...
    def hash
      [ach, eft, bacs, international].hash
    end
