...
module MoneyKit
  class CreateLinkSessionRequest
    ...
    attr_accessor :custom_sandbox_data
    ...
    def self.attribute_map
      {
        ...
        :'custom_sandbox_data' => :'custom_sandbox_data'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'custom_sandbox_data' => :'CustomSandboxData'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MoneyKit::CreateLinkSessionRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'custom_sandbox_data')
        self.custom_sandbox_data = attributes[:'custom_sandbox_data']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          custom_sandbox_data == o.custom_sandbox_data
    end
    ...
    def hash
      [settings, customer_user, existing_link_id, institution_id, redirect_uri, webhook, link_tags, connect_features, custom_sandbox_data].hash
    end
