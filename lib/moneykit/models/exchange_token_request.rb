...
module MoneyKit
  class ExchangeTokenRequest
    ...
    attr_accessor :exchangeable_token
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MoneyKit::ExchangeTokenRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] exchangeable_token Value to be assigned
    def exchangeable_token=(exchangeable_token)
      if exchangeable_token.nil?
        fail ArgumentError, 'exchangeable_token cannot be nil'
      end
