...
module MoneyKit
  class TransactionsLinkProduct
    ...
    # The type of error, if the last attempt to refresh the product failed.
    ...
    # DEPRECATED:  The settings given when this product was created.  This field is deprecated and will be removed.
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MoneyKit::TransactionsLinkProduct`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] has_history Value to be assigned
    def has_history=(has_history)
      if has_history.nil?
        fail ArgumentError, 'has_history cannot be nil'
      end
