...
module MoneyKit
  class Institution
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MoneyKit::Institution`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] institution_id_aliases Value to be assigned
    def institution_id_aliases=(institution_id_aliases)
      if institution_id_aliases.nil?
        fail ArgumentError, 'institution_id_aliases cannot be nil'
      end
