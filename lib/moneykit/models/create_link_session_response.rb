...
module MoneyKit
  class CreateLinkSessionResponse
    ...
    attr_accessor :link_session_token
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MoneyKit::CreateLinkSessionResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] link_session_token Value to be assigned
    def link_session_token=(link_session_token)
      if link_session_token.nil?
        fail ArgumentError, 'link_session_token cannot be nil'
      end
