...
module MoneyKit
  ...
  class LinkErrorBadStateResponse
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MoneyKit::LinkErrorBadStateResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] link_error_code Value to be assigned
    def link_error_code=(link_error_code)
      if link_error_code.nil?
        fail ArgumentError, 'link_error_code cannot be nil'
      end
    ...
    def hash
      [error_code, error_message, documentation_url, link_error_code].hash
    end
