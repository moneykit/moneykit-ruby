...
module MoneyKit
  class GetInvestmentTransactionsResponse
    ...
    # A list of securities involved in these transactions.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MoneyKit::GetInvestmentTransactionsResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MoneyKit::GetInvestmentTransactionsResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'investment_transactions')
        ...
        self.investment_transactions = nil
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] investment_transactions Value to be assigned
    def investment_transactions=(investment_transactions)
      if investment_transactions.nil?
        fail ArgumentError, 'investment_transactions cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] securities Value to be assigned
    def securities=(securities)
      if securities.nil?
        fail ArgumentError, 'securities cannot be nil'
      end
    ...
    def hash
      [total, page, size, investment_transactions, securities, accounts, link].hash
    end
