...
module MoneyKit
  class LinkSessionSettingOverrides
    ...
    # Restricts the available institutions to those in **any** of these countries.  If more than         one country is listed, the institution panel shown to the user will be prioritied by the order given. If         omitted, your app's primary country is used (the default is US).
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MoneyKit::LinkSessionSettingOverrides`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [providers, products, countries].hash
    end
