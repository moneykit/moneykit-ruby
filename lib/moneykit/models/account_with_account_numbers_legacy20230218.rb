...
module MoneyKit
  class AccountWithAccountNumbersLegacy20230218
    ...
    # The various types of account numbers. Each list will always contain at most only one set         of numbers per account.
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MoneyKit::AccountWithAccountNumbersLegacy20230218`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [account_id, account_type, name, nickname, account_mask, balances, original_id, closed, numbers].hash
    end
