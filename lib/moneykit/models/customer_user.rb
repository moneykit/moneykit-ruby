...
module MoneyKit
  class CustomerUser
    ...
    # The user's email address.  This field is optional, but either email or phone must be provided         to enable improved link conversion.
    attr_accessor :email

    # The user's mobile phone number.  This field is optional, but either email or phone must be         provided to enable improved link conversion.
    attr_accessor :phone
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MoneyKit::CustomerUser`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
