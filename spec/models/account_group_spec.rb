...
# Unit tests for MoneyKit::AccountGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MoneyKit::AccountGroup do
  let(:instance) { MoneyKit::AccountGroup.new }

  describe 'test an instance of AccountGroup' do
    it 'should create an instance of AccountGroup' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(MoneyKit::AccountGroup)
    end
  end
