...
# Unit tests for MoneyKit::LinkStateChangedWebhook
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MoneyKit::LinkStateChangedWebhook do
  let(:instance) { MoneyKit::LinkStateChangedWebhook.new }

  describe 'test an instance of LinkStateChangedWebhook' do
    it 'should create an instance of LinkStateChangedWebhook' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(MoneyKit::LinkStateChangedWebhook)
    end
  end
